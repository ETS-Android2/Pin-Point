...
public final class User implements Model {
  ...
  private final @ModelField(targetType="Following") @HasMany(associatedWith = "userID", type = Following.class) List<Following> followings = null;
  private final @ModelField(targetType="Follower") @HasMany(associatedWith = "userID", type = Follower.class) List<Follower> followers = null;
